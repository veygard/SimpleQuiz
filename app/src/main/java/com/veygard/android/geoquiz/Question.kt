    ...
    companion object {
        ...
        fun getQuestionListAtStart(): List<Question> {
            return listOf(
                ...
                Question(" Какая из этих пород уток является яичной, а не мясной? ", "Индийские бегуны", " Пекинские", " Серые украинские", " Черные белогрудые ", false),
                ...
                Question(" Денежная единица Узбекистана ", "Сум", " Сум", " Сум", " Сум ", false),
                Question(" Ден.единица ЮАР ", "Рэнд", " Рэнд", " Рэнт", " Рэнд ", false),
                Question(" Ден.единица(Норвегии,Швеции,Дании,Чехии,Эстонии в 2010 году) ", "Крона", " Крона", " Крона", " Разменная монета эре ", false),
                Question(" Валюта Таджикистана ", "Сомони", " Сомони", " Сомони", " Сомони ", false),
                ...
                Question(" Их в России 19-го века, называли рыцарями зеленых полей ", "Шулеры", " Шулеры", " Шулеры", " Шулеры ", false),
                ...
                Question(" Известная кулинарная передача со строгим ведущим на рен тв. ", "Адская кухня", " Адская кухня", " Адская кухня", " Адская кухня ", false),
